import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{r as e,o as t,c as o,a as n,b as s,d as c,e as l}from"./app.ec1dbc6f.js";const i={},u=n("h1",{id:"exercicio-freetime",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#exercicio-freetime","aria-hidden":"true"},"#"),s(" Exerc\xEDcio: FreeTime")],-1),k=n("p",null,"No nosso campus Santo Ant\xF4nio de Jesus temos a lanchonete FreeTime que est\xE1 passando por um processo de informatiza\xE7\xE3o no qual ir\xE1 disponibilizar a realiza\xE7\xE3o de pedidos atrav\xE9s de um aplicativo WEB. Nesse aplicativo o cliente poder\xE1 escolher os itens da lanchonete, realizar o pagamento e apresentar o comprovante (um QRCode de autoriza\xE7\xE3o) para retirar o seu lanche sem precisar pegar a fila para comprar a ficha.",-1),d=n("p",null,"Para o comportamento de realizar pagamento e obter c\xF3digo de autoriza\xE7\xE3o basta criar os m\xE9todos com coment\xE1rios explicando que ali estaria a logica de obter codigo ou realizar pagamento.",-1),r=n("p",null,"Escreve tamb\xE9m o c\xF3digo de uma classe principal que ir\xE1 fazer uso das classes que representam os conceitos para exemplificar a realiza\xE7\xE3o de uma compra e retirada do lanche.",-1),v=n("h1",{id:"link",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#link","aria-hidden":"true"},"#"),s(" Link")],-1),m={href:"https://classroom.github.com/a/bvybI78M",target:"_blank",rel:"noopener noreferrer"},b=l(`<details class="custom-container details"><summary>Detalhe</summary><div class="language-java ext-java line-numbers-mode"><pre class="language-java"><code><span class="token comment">/*----------------------------------------------------------------------------------------
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">App</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token keyword">int</span> codigoPedido <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
        <span class="token class-name">Pedido</span> pedido <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Pedido</span><span class="token punctuation">(</span>codigoPedido<span class="token punctuation">,</span>cliente<span class="token punctuation">)</span><span class="token punctuation">;</span>
